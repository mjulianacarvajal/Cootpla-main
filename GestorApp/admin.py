...
from .models import Conductor,Propietario,Sede, Encomienda,Vehiculo,Programacion, Venta
...
class VentaAdmin(ImportExportModelAdmin):
    list_display = ('codigo_compra','comprador','documento','programacion_venta','asientos_compra','estado','fecha_creado','fecha_actualizado')